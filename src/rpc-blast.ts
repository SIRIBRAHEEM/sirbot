...
function labelFromUrl(url: string, index: number): string {
  ...
  if (lower.includes("sequencer.mainnet.chain.robinhood.com")) return "robinchain-sequencer";
  if (lower.includes("rpc.mainnet.chain.robinhood.com")) return "robinchain-public";
...
// Blast a raw signed tx to all RPC endpoints simultaneously
